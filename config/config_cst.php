...
const BAN_DAYS = array(0,1,7,15,30,90,365); // Index 0..6 correspond to ban duration between 0 and 365 days
...
const QT_CONVERT_AMP = false; // In message, title and profile info, saves &amp; instead of &. Use TRUE to make &#0000; symbols NOT working.

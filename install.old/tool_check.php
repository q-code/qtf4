...
// 1 file exist
  ...
  if ( !file_exists($root.'bin/lib_qtf_base.php') ) $error .= 'File <b>lib_qtf_base.php</b> is not in the <b>bin</b> directory. Application cannot start.<br>';
  ...
  if ( !file_exists($root.'bin/class_qtf_section.php') ) $error .= 'File <b>class_qtf_section.php</b> is not in the <b>bin/class</b> directory. Application cannot start.<br>';
  if ( !file_exists($root.'bin/class_qtf_topic.php') ) $error .= 'File <b>class_qtf_topic.php</b> is not in the <b>bin/class</b> directory. Application cannot start.<br>';
  if ( !file_exists($root.'bin/class_qtf_post.php') ) $error .= 'File <b>class_qtf_post.php</b> is not in the <b>bin/class</b> directory. Application cannot start.<br>';
...
echo '</p><p>';
if ( is_dir($root.'install') ) echo '<a href="setup_9.php">Prevent other installation...</a> | ';

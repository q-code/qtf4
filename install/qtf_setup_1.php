...
if ( isset($_POST['ok']) ) try {
  ...
  if ( $arr['QDB_SYSTEM']=='pdo.sqlite' || $arr['QDB_SYSTEM']=='sqlite' )
  {
    ...
    if ( !file_exists('../'.$arr['QDB_DATABASE']) ) throw new Exception( '<p>SQLite database file not found: '.$arr['QDB_DATABASE'].'</p><p><a href="qtf_setup_1.php?sqlite='.$arr['QDB_DATABASE'].'">Create SQLite file ['.$arr['QDB_DATABASE'].']...</a></p>' );
  }
  else
  {
...
<p style="margin:0 0 20px 0"><a href="qtf_setup_0.php">Load from template...</a></p></td>
</tr>
';
echo '<tr>

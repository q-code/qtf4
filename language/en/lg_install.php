...
$L['E_save'] = "<br><br><b>Problem to write into /bin/ folder</b><br><br>Possible causes:<br>&raquo;&nbsp;File /config/config_db.php is missing.<br>&raquo;&nbsp;File /config/config_db.php is read-only.<br>";

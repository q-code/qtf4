...
if ( $canEdit ) {
  echo '<a class="button" href="'.Href($oH->selfurl).'?id='.$id.'&edit='.($_SESSION[QT]['editing'] ? 0 : 1).'" onclick="return qtFormSafe.exit(e0);">'.getSVG('pen','class=btn-prefix').L($_SESSION[QT]['editing'] ? 'Edit_stop' : 'Edit_start').'</a>';
}
